...
namespace SINS
{
    public partial class frmDatosEstudiante : Form
    {
        ...
        private void lklblAvanzado_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            AvanzadoOpcionesItem av = new AvanzadoOpcionesItem();
            av.IdItem = estudianteActual.Id;
            av.DescripcionItem = estudianteActual.Nombre + " " + estudianteActual.Apellidos;
            av.RelacionItem = "tblEstudiante";
            av.TipoItem = "Estudiante";
            frmAvanzadoItem frm = new frmAvanzadoItem(av);
            frm.ShowDialog();
            frm.Dispose();
        }
