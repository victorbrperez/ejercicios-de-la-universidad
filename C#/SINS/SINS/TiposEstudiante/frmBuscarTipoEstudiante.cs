...
namespace SINS
{
    public partial class frmBuscarTipoEstudiante : Form
    {
        ...
        {
            IdTipoEstudianteSeleccionado = 0;
            this.Close();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dgvTiposEstudiantes.RowCount > 0)
            {
                try
                {
                    frmDatosTipoEstudiante frm = new frmDatosTipoEstudiante(Utiles.DbItem.Actualizar, Convert.ToInt32(dgvTiposEstudiantes.CurrentRow.Cells["Id"].Value.ToString()));
                    frm.ShowDialog();
                    frm.Dispose();
                }
                catch (Exception)
        ...
        private void frmBuscarTipoEstudiante_Load(object sender, EventArgs e)
        {
        ...
        {
            IdTipoEstudianteSeleccionado = Convert.ToInt32(dgvTiposEstudiantes.CurrentRow.Cells["Id"].Value.ToString());
            this.Close();
        }
    }
}
