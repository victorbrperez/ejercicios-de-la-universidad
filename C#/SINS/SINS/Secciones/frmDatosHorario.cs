...
namespace SINS
{
    public partial class frmDatosHorario : Form
    {
        ...
        private void nudHoraInicio_Enter(object sender, EventArgs e)
        {
            nudHoraInicio.SelectAll();
        }

        private void nudHoraInicio_Click(object sender, EventArgs e)
        {
            nudHoraInicio.SelectAll();
        }

        private void nudMinutosInicio_Enter(object sender, EventArgs e)
        {
            nudMinutosInicio.SelectAll();
        }

        private void nudMinutosInicio_Click(object sender, EventArgs e)
        {
            nudMinutosInicio.SelectAll();
        }

        private void nudHoraFin_Enter(object sender, EventArgs e)
        {
            nudHoraFin.SelectAll();
        }

        private void nudHoraFin_Click(object sender, EventArgs e)
        {
            nudHoraFin.SelectAll();
        }

        private void nudMinutosFIn_Enter(object sender, EventArgs e)
        {
            nudMinutosFIn.SelectAll();
        }

        private void nudMinutosFIn_Click(object sender, EventArgs e)
        {
            nudMinutosFIn.SelectAll();
        }
        //
